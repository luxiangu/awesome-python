...
- General
    ...
    * [Pattern](https://github.com/clips/pattern) - A web mining module with tools for scraping, natural language processing, machine learning, network analysis and visualization.
- Chinese
